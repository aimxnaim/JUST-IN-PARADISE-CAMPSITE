          ...
          <div class="u-repeater u-repeater-1">
            ...
            <div class="u-container-style u-list-item u-repeater-item">
              <div class="u-container-layout u-similar-container u-container-layout-2"><span class="u-custom-item u-file-icon u-icon u-icon-2"><img src="images/booking.png" alt=""></span>
                <p class="u-small-text u-text u-text-default u-text-variant u-text-2"></p>
                <a href="CustomerController?action=listCustomer&staffid=<c:out value="${staff.staffid}"/>" class="u-border-5 u-border-grey-60 u-btn u-btn-round u-button-style u-hover-custom-color-6 u-palette-3-light-1 u-radius-25 u-btn-2">LIST OF CUSTOMER DETAILS&nbsp;</a>
              </div>
            </div>
            <div class="u-container-style u-list-item u-repeater-item">
              <div class="u-container-layout u-similar-container u-container-layout-3"><span class="u-custom-item u-file-icon u-icon u-icon-3"><img src="images/customer-feedback.png" alt=""></span>
                ...
                <a href="BookingController?action=listBooking&staffid=<c:out value="${staff.staffid}"/>" class="u-border-5 u-border-grey-60 u-btn u-btn-round u-button-style u-hover-custom-color-6 u-palette-3-light-1 u-radius-25 u-btn-3">CUSTOMER BOOKING INFORMATION&nbsp;</a>
              </div>
            </div>
          </div>
        </div>
