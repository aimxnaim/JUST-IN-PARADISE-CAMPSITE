...
<html style="font-size: 16px;">
  <head>
	...
	<link rel="stylesheet" href="Update_Staff.css" media="screen">
    ...
    <meta property="og:title" content="Update_Staff">
    ...
    <section class="u-clearfix u-image u-section-1" id="sec-e47e" data-image-width="1920" data-image-height="940">
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <div class="u-form u-form-1">
          <form action="StaffController" method="POST" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 10px;">
            <div class="u-form-group u-form-name u-label-left u-form-group-1">
              <label for="staffid" class="u-custom-font u-font-raleway u-label u-label-1">Staff ID</label>
              <input type="text" id="staffid" name="staffid" class="u-border-4 u-border-grey-30 u-input u-input-rectangle u-radius-15 u-white" value="<c:out value="${staff.staffid}"/>" required="required" autofocus="autofocus" readonly>
            </div>
            <div class="u-form-group u-form-name u-label-left">
              <label for="staffname" class="u-custom-font u-font-raleway u-label u-label-2">Name</label>
              <input type="text" placeholder="Enter your Name" id="staffname" name="staffname" class="u-border-4 u-border-grey-30 u-input u-input-rectangle u-radius-15 u-white" value="<c:out value="${staff.staffname}"/>" required="">
            </div>
            <div class="u-form-address u-form-group u-label-left u-form-group-3">
              <label for="staffaddress" class="u-custom-font u-font-raleway u-label u-label-3">Address</label>
              <input type="text" placeholder="Enter your address" id="staffaddress" name="staffaddress" class="u-border-4 u-border-grey-30 u-input u-input-rectangle u-radius-15 u-white" value="<c:out value="${staff.staffaddress}"/>" required="">
            </div>
            <div class="u-form-group u-form-phone u-label-left u-form-group-4">
              <label for="staffphone" class="u-custom-font u-font-raleway u-label u-label-4">Phone</label>
              <input type="tel" pattern="\+?\d{0,3}[\s\(\-]?([0-9]{2,3})[\s\)\-]?([\s\-]?)([0-9]{3})[\s\-]?([0-9]{2})[\s\-]?([0-9]{2})" placeholder="Enter your phone (e.g. +60123456789)" id="staffphone" name="staffphone" value="<c:out value="${staff.staffphone}"/>" class="u-border-4 u-border-grey-30 u-input u-input-rectangle u-radius-15 u-white" required="">
            </div>
             <div class="u-form-group u-form-phone u-label-left u-form-group-3">
                  <input type="hidden" name="userid" value="<c:out value="${staff.userid}"/>"  class="u-border-3 u-border-grey-70 u-input u-input-rectangle u-radius-30 u-text-grey-90 u-white">
             </div>
            <div class="u-form-group u-form-submit u-label-left">
              <label class="u-custom-font u-font-raleway u-label u-label-5"></label>
              <div class="u-align-right u-btn-submit-container">
              	<input type="submit" value="Update" class="u-border-none u-btn u-btn-round u-btn-submit u-button-style u-custom-color-6 u-custom-font u-font-ubuntu u-radius-17 u-btn-2">
              </div>
