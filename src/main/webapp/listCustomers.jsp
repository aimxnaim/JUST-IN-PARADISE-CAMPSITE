...
<html style="font-size: 16px;"><head>
          ...
          <table class="u-table-entity">
            ...
            <tbody class="u-palette-3-light-2 u-table-body u-table-body-1">
              ...
              <tr style="height: 76px;">
                ...
                <td class="u-border-1 u-border-palette-3-dark-2 u-table-cell"><a class="u-border-none u-btn u-button-style u-custom-color-3 u-hover-custom-color-4 u-btn-2" href="CustomerController?action=viewCustomer&custid=<c:out value="${customer.custid}" />">View</a></td>
                <td class="u-border-1 u-border-palette-3-dark-2 u-table-cell"> <a class="u-border-none u-btn u-button-style u-hover-palette-3-base u-palette-3-light-1 u-btn-7" href="CustomerController?action=updateCustomerByStaff&custid=<c:out value="${customer.custid}" />">Update</a></td>
                <td class="u-border-1 u-border-palette-3-dark-2 u-table-cell"><input type="hidden" id="userid-${customers.index}" value="<c:out value="${customer.userid}"/>"><button class="u-border-none u-btn u-button-style u-hover-palette-2-base u-palette-2-light-1 u-btn-4" onclick="confirmation('${customers.index}')">Delete</button></td>
              </tr>
              </c:forEach>
            </tbody>
          </table>
  ...
  <script>
		function confirmation(index){
			  ...
			  if (r == true) {				 		  
				  location.href = 'CustomerController?action=deleteCustomer&userid=' + userid;
